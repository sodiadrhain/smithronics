...
class PostsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('staffend.posts.index', compact('posts'));
    }
    ...
    public function create()
    {
        ...
        return view('staffend.posts.create', compact('categories'));
    }
...
$slug = $slug.'-'.$request->get('price');
        ...
        return redirect('/staff/posts/create')->with('status', 'Product is added successfully!');
    }
    ...
    public function edit($id)
    {
        ...
        return view('staffend.posts.edit', compact('post', 'categories', 'selectedCategories'));
    }
    ...
    public function update(Request $request, $id)
    {
      ...
      $post->save();
      $post->categories()->sync($request->get('categories'));
      return redirect(action('Staff\PostsController@edit', $post->id))->with('status', 'Product has been updated!');
    }
    ...
    public function search(Request $request)
    {
      ...
      if(isset($query)){
        ...
        return view('staffend.posts.index', compact('post', 'query'));
      } else{
      $post = "";
      return view('staffend.posts.index', compact('post'));
    }
    }
}
