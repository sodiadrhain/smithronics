  ...
  <div class="row banner">
    <div class="">
      <div class="list-group">
        <center>
        <form method="GET" action="{!! action('Admin\PostsController@search') !!}" role="search" rout="search">
          {!! csrf_field()  !!}
      ...
      <a href="{!! action('Admin\PostsController@edit', $key_pay1->id) !!}" class="btn btn-default btn-raised">Edit Product</a>
      <?php
      echo '  </div>
      </div>
      <div class="list-group-separator">
      ...
      ?>
            ...
            foreach ($posts2 as $key_pay) {
              ...
              $available1 = $key_pay->available;
              if($available1 == 0){
                $deactivated1 = "<font style='color:#000000;'>   (this product is unavailable)</font>";
              } else {
                $deactivated1 = " ";
              }
            ?>
            ...
            <p style="color:#b22222;"><b>Product name:</b> <?php echo $key_pay->title; echo " "; echo $deactivated1; ?></p>
            ...
            <a href="{!! action('Admin\PostsController@edit', $key_pay->id) !!}" class="btn btn-default btn-raised">Edit Product</a>
