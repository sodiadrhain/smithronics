      ...
      <div class="contact-agileinfo">
        ...
        <div class="contact-right wthree">
          <div class="col-xs-7 contact-text w3-agileits">
            <h4>GET IN TOUCH :</h4>
            <p>
              <i class="fa fa-map-marker"></i> Shop 8, umeihedi plaza behind Gbo plaza, Alaba international market, Ojo, Lagos State.</p>
            <p>
              <i class="fa fa-phone"></i> Telephone : 080 6400 0024, 080 6411 4612</p>
              <p>
              <i class="fa fa-envelope-o"></i> Email :
              <a href="mailto:smithronics@yahoo.com">smithronics@yahoo.com</a>
            </p>
          </div>
