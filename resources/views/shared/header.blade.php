  ...
  <div class="header-bot_inner_wthreeinfo_header_mid">
    ...
    <div class="col-md-8 header">
      ...
      <ul>
        ...
        <li>
            <a href="/">
            <span class="fa fa-ship" aria-hidden="true"></span> Shop Now</a>
        </li>
        <li>
            <a href="{{action('ProductController@orders')}}">
            <span class="fa fa-file-text-o" aria-hidden="true"></span> Order List</a>
        </li>
      @endif
        <li>
        ...
        @else
        <li>
          <a href="{{ '/users/login' . '?previous=' . Request::fullUrl() }}">
      ...
      <div class="top_nav_right">
        <div class="wthreecartaits wthreecartaits2 cart cart box_1">
          <form action="/users/orders" method="get" class="last">
